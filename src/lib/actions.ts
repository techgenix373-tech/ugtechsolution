...
const FormSchema = z.object({
  ...
  contentFormat: z.enum(['blog', 'listicle', 'how-to', 'comparison', 'case-study', 'review', 'faq', 'press-release', 'promotional-email', 'transactional-email', 'welcome-email', 'newsletter']),
});
